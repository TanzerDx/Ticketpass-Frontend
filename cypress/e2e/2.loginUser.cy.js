...
describe('User Login Page', () => {
  ...
  describe('Unsuccessful log in', () => {
    ...
    beforeEach(() => {
      ...
      cy.get('[data-testid="cypress-loginUser-input-email"]').type('real@email.com')
      cy.get('[data-testid="cypress-loginUser-input-email"]').should('have.value', 'real@email.com')
      
      cy.get('[data-testid="cypress-loginUser-input-password"]').type('veryWrongPassword')
      cy.get('[data-testid="cypress-loginUser-input-password"]').should('have.value', 'veryWrongPassword')
    ...
    it('does not log in the user since they provided incorrect credentials', () => {
      ...
      cy.get('.cypress-toastify-error-login')
