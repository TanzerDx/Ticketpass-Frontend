...
function AdminUpdateConcert() {
  ...
  const handleUpdateConcert = (event) => {
    ...
    WebSocketsConfig.publishMessage(
      `/topic/${concertId}`,
      `The information about ${formData.artist}'s concert has been updated! Check your order for more info!`
    );
