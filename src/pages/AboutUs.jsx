          ...
          <div className="aboutUs-grid-left">
            <div className="aboutUs-description">
              <h1 className="remove-margin">
                Ticketpass is a website created by Ticketpass Inc. in 2023. It
                was established in Eindhoven, the Netherlands, solely by an
                university student. The goal of the website is to provide the
                concert lovers with a platform for purchasing concert tickets,
                getting rid of the burden of obtaining tickets from separate
                venue websites.
              </h1>
            </div>
          </div>
