...
function Checkout() {
  ...
  useEffect(() => {
    UserService.getUserByAccessToken(accessToken).then((data) => {
      setUser(data);
    });
  }, []);
            ...
            <form data-testid="cypress-checkout-form" onSubmit={handleCheckout}>
              <div className="checkout-grid-left">
                <div className="checkout-validation-text">
                  <h1 className="checkout-remove-margin">
                    Number of tickets:{" "}
                  </h1>
                </div>
                ...
                <button
                  type="button"
                  name="buttonMinus"
                  className="button-ticket-management"
                ...
                <div className="payment-method-grid">
                  ...
                  <div
                    className={`payment-method ${
                      selectedPaymentMethod === "iDeal" ? "selected" : ""
                    }`}
                ...
                <div className="checkbox-container-flex">
                  ...
                  <label
                    ...
                    className="checkout-agreeCheckbox"
                  >
            ...
            <div className="checkout-grid-right">
              <div className="checkout-concert-info-box">
                ...
                <div className="checkout-concert-info-description">
                  ...
                  <h1 className="checkout-remove-margin">
                    Date:{" "}
                    {format(new Date(concertData.date), "dd-MM-yyyy HH:mm")}
                  </h1>
                  <h1 className="checkout-remove-margin">
