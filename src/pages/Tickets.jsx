                        ...
                        {order? (
                            ...
                            <div className="tickets-headers-flexbox">
                                <div className='tickets-heading'>
                                    <h1 className='tickets-remove-margin'>{order.concert.artist} - TICKETS</h1>
                                </div>
                                <div className="tickets-order-details">
                                    <h1 className='tickets-remove-margin'>ORDER ID: {order.id}</h1>
                                    <h1 className='tickets-remove-margin'>DATE ACQUIRED: {order.date}</h1>
                                </div>
                            </div>
                            <div className="tickets-warning">
                                <h1 className='tickets-remove-margin'>SECURITY WILL SCAN THE BARCODE(S) AT THE ENTRANCE TO GAIN ACCESS TO THE VENUE</h1>
                            </div>
