        ...
        if (accessToken) {
          ...
          if (user) {
            ...
            if (Array.isArray(orders.orders)) {
              ...
              const concertIdsSet = new Set(
                retrievedOrders.map((order) => order.concert.id)
              );
          ...
          <>
            <div className="navbar-notifications-container">
              <img
                ...
                alt="Notifications"
                className="navbar-notifications-icon"
              />
        ...
        {user && user.role === "banned" && (
          <>
            <button
              onClick={logout}
              id="navbar-item-text"
              className="navbar-logout-banned"
            >
              LOGOUT
            </button>
          </>
